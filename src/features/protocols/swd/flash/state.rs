use crate::features::protocols::flashing::state::{SwdConfigField, SwdConnectMode};
use crate::ui::widgets;

pub struct SwdFlashState {
    pub probe_list: Vec<String>,
    pub probe_idx: usize,
    pub speed_idx: usize,
    pub connect_mode: SwdConnectMode,
    pub verify: bool,
    pub reset_run: bool,
...
impl SwdFlashState {
    pub fn new() -> Self {
        Self {
            ...
            probe_idx: 0,
            speed_idx: 2,
            connect_mode: SwdConnectMode::Normal,
            verify: true,
            reset_run: true,
